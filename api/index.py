...
def register():
    if request.method == 'POST':
        ...
        # Print token (in production, send via secure method)
        print(f"\n{'=' * 50}")
                ...
                <div class="max-w-md mx-auto bg-white rounded-lg shadow p-6">
                    ...
                    <form onsubmit="submitForm(event)" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="skill" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                {skills_html}
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="amount" min="1" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        </div>
